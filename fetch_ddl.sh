...
do awk 'NR == n' n="${rotate}" /home/jenkins/agent/workspace/Snowflake_test_test_dev/Objectlist.txt > /home/jenkins/agent/workspace/Snowflake_test_test_dev/oneline.txt
